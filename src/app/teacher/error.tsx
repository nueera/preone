  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="text-center max-w-md">
        ...
        <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Teacher Portal Error</h3>
        ...
        <div className="flex items-center gap-3 justify-center">
          ...
          <a href="/teacher" className="px-4 py-2 rounded-xl border border-[var(--border-default)] text-sm font-medium hover:bg-[var(--bg-secondary)] transition-colors">
            Back to Dashboard
          </a>
        </div>
      </div>
