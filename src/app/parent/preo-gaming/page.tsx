...
// ============================================================
// PreOne — PreO Gaming Page (Coming Soon)
...
export default function PreoGamingPage() {
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <div
          ...
          style={{ background: 'var(--parent-pink-soft)' }}
        >
          <Gamepad2 className="h-6 w-6" style={{ color: 'var(--parent-pink)' }} />
        </div>
        <div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: 'var(--parent-text-muted)' }}>
            We&apos;re working hard to bring you PreO Gaming. Stay tuned for updates.
          </p>
        </div>
      </PreOneCard>
      ...
      <PreOneCard className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-sm mt-2" style={{ color: 'var(--parent-text-subtle)' }}>
          Educational games, progress tracking, and leaderboards are under development.
        </p>
      </PreOneCard>
    </div>
  );
