  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="text-center max-w-md">
        ...
        <p className="text-sm text-[var(--text-tertiary)] mb-6">{error.message || 'An unexpected error occurred'}</p>
        ...
        <div className="flex items-center gap-3 justify-center">
          ...
          <a href="/parent" className="px-4 py-2 rounded-xl border border-[var(--border-default)] text-sm font-medium hover:bg-[var(--bg-secondary)] transition-colors">
            Back to Home
          </a>
        </div>
      </div>
