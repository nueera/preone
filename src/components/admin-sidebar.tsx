...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Error Monitor', icon: AlertTriangle, href: '/admin/errors', roles: ['ADMIN'] },
  ...
  { label: 'Announcements', icon: Megaphone, href: '/admin/announcements', roles: ['ADMIN', 'TASK_MASTER'] },
