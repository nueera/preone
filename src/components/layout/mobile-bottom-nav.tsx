...
const NAV_ITEMS: Record<NavRole, NavItem[]> = {
  parent: [
    ...
    { label: 'Chat', icon: MessageCircle, href: '/parent/communication' },
  ...
  teacher: [
    ...
    { label: 'Chat', icon: MessageCircle, href: '/teacher/communication' },
    { label: 'More', icon: Calendar, href: '/teacher/settings' },
  ],
  admin: [
    { label: 'Home', icon: Home, href: '/admin/dashboard' },
    { label: 'Students', icon: Users, href: '/admin/students' },
    { label: 'Chat', icon: MessageCircle, href: '/admin/communication' },
